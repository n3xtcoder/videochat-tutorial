...
describe('/user', () => {
  ...
  it('returns 200 with jwt when username+password is correct', async () => {
    username = 'doctor';
    password = 'password';
  ...
  it('returns 401 when username case is not correct', async () => {
    username = 'Doctor';
    password = 'password';
    const response = await request.post('/user').send({ username, password });
  ...
  it('returns 401 when username exists but the password is incorrect', async () => {
    username = 'doctor';
